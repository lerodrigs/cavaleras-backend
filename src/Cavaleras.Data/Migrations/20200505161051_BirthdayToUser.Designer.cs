...
namespace Cavaleras.Data.Migrations
{
    ...
    [Migration("20200505161051_BirthdayToUser")]
    partial class BirthdayToUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Calaveras.Domain.Entities.Address", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Calaveras.Domain.Entities.Address", b =>
                {
                    b.HasOne("Calaveras.Domain.Entities.User", "User")
                        .WithMany("Addresses")
